...
describe('extractMaskBuffer', () => {
  ...
  it('extracts a 2x2 center region using coordinates', () => {
    ...
    const result = extractMaskBuffer(fullMask, maskWidth, 1, 1, 2, 2)
  ...
  it('extracts a region using a Rect object', () => {
    ...
    const result = extractMaskBuffer(fullMask, maskWidth, rect)
  ...
  it('handles regions partially out of bounds (clipping)', () => {
    ...
    const result = extractMaskBuffer(fullMask, maskWidth, 3, 3, 2, 2)
  ...
  it('returns an empty array if completely out of bounds', () => {
    const result = extractMaskBuffer(fullMask, maskWidth, 10, 10, 2, 2)
