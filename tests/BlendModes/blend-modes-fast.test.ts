...
describe('Color Fast Blending Functions', () => {
  ...
  describe('overwriteColor32', () => {
    it('returns the source color regardless of destination', () => {
      ...
      const result = FAST_BLEND_MODE_BY_NAME.overwrite(src, dst)
  ...
  describe('sourceOver', () => {
    it('returns src if src alpha is 255', () => {
      const result = FAST_BLEND_MODE_BY_NAME.sourceOver(opaqueRed, opaqueBlue)
      expect(unpack(result)).toEqual({
        r: 255,
        g: 0,
        b: 0,
    ...
    it('blends values correctly at 50% alpha', () => {
      ...
      const dst = 0xFF000000 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.sourceOver(src, dst)
      // expected drift of -1
      expect(unpack(result)).toEqual({
        r: 127,
        g: 127,
  ...
  describe('darkenColor32', () => {
    it('selects source when lumSrc < lumDst (opaque)', () => {
      const result = FAST_BLEND_MODE_BY_NAME.darken(opaqueRed, opaqueWhite)
      expect(unpack(result)).toEqual({
        r: 255,
        g: 0,
        b: 0,
    ...
    it('selects destination when lumDst < lumSrc (opaque)', () => {
      const result = FAST_BLEND_MODE_BY_NAME.darken(opaqueWhite, opaqueBlack)
      expect(unpack(result)).toEqual({
        r: 0,
        g: 0,
        b: 0,
    ...
    it('handles the sa === 255 optimization branch', () => {
      ...
      const result = FAST_BLEND_MODE_BY_NAME.darken(src, dst)
      expect(unpack(result)).toEqual({
        r: 51,
        g: 34,
        b: 17,
    ...
    it('handles lerp branch (0 < sa < 255)', () => {
      const result = FAST_BLEND_MODE_BY_NAME.darken(halfAlphaRed, opaqueBlue)
      // expected drift of -1
      expect(unpack(result)).toEqual({
        r: 0,
        g: 0,
  ...
  describe('multiplyColor32', () => {
    it('multiplies colors correctly', () => {
      ...
      const dst = 0xFFFFFFFF as Color32
      const result = FAST_BLEND_MODE_BY_NAME.multiply(src, dst)
      expect(unpack(result)).toEqual({
        r: 127,
        g: 127,
        b: 127,
  ...
  describe('colorBurnColor32', () => {
    it('handles sa === 255 branch', () => {
      const result = FAST_BLEND_MODE_BY_NAME.colorBurn(midGray, midGray)
      // expected drift of -1 (excluding alpha)
      expect(unpack(result)).toEqual({
        r: 1,
        g: 1,
        b: 1,
    ...
    it('handles the dr === 255 edge case', () => {
      const result = FAST_BLEND_MODE_BY_NAME.colorBurn(opaqueRed, opaqueWhite)
      expect(unpack(result)).toEqual({
        r: 255,
        g: 255,
        b: 255,
    ...
    it('handles the sr === 0 division guard', () => {
      const result = FAST_BLEND_MODE_BY_NAME.colorBurn(opaqueBlack, midGray)
      expect(unpack(result)).toEqual({
        r: 0,
        g: 0,
        b: 0,
    ...
    it('hits the sr === 0 branch via the || 1 fallback', () => {
      ...
      const result = FAST_BLEND_MODE_BY_NAME.colorBurn(opaqueBlack, dst)
      expect(unpack(result)).toEqual({
        r: 0,
        g: 0,
        b: 0,
    ...
    it('handles lerp branch (0 < sa < 255)', () => {
      const src = 0x80FFFFFF as Color32
      const dst = 0xFF000000 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.colorBurn(src, dst)
      // expected drift of -1
      expect(unpack(result)).toEqual({
        r: 0,
        g: 0,
  ...
  describe('linearBurnColor32', () => {
    it('handles sa === 255 branch', () => {
      const result = FAST_BLEND_MODE_BY_NAME.linearBurn(midGray, midGray)
      expect(unpack(result)).toEqual({
        r: 1,
        g: 1,
        b: 1,
    ...
    it('handles clamping to 0', () => {
      const result = FAST_BLEND_MODE_BY_NAME.linearBurn(opaqueBlack, opaqueBlack)
      expect(unpack(result)).toEqual({
        r: 0,
        g: 0,
        b: 0,
    ...
    it('handles lerp branch', () => {
      const result = FAST_BLEND_MODE_BY_NAME.linearBurn(halfAlphaRed, midGray)
      // expected drift of -1 (for r and a)
      expect(unpack(result)).toEqual({
        r: 127,
        g: 63,
        b: 63,
  ...
  describe('darkerColor32 coverage', () => {
    it('selects source color when lumSrc < lumDst (opaque)', () => {
      const result = FAST_BLEND_MODE_BY_NAME.darkerColor(opaqueBlue, opaqueRed)
      expect(unpack(result)).toEqual({
        r: 0,
        g: 0,
        b: 255,
    ...
    it('selects destination color when lumDst < lumSrc (opaque)', () => {
      const result = FAST_BLEND_MODE_BY_NAME.darkerColor(opaqueWhite, opaqueBlack)
      expect(unpack(result)).toEqual({
        r: 0,
        g: 0,
        b: 0,
    ...
    it('handles the sa === 255 branch correctly', () => {
      ...
      const result = FAST_BLEND_MODE_BY_NAME.darkerColor(src, dst)
      expect(unpack(result)).toEqual({
        r: 86,
        g: 52,
        b: 18,
    ...
    it('handles the lerp branch (sa < 255) when source is darker', () => {
      ...
      const result = FAST_BLEND_MODE_BY_NAME.darkerColor(src, opaqueWhite)
      // expected drift of -1
      expect(unpack(result)).toEqual({
        r: 126,
        g: 126,
  ...
  describe('lightenColor32', () => {
    it('should return destination when source is fully transparent', () => {
      ...
      const result = FAST_BLEND_MODE_BY_NAME.lighten(src, dst)
      expect(unpack(result)).toEqual({
        r: 51,
        g: 34,
        b: 17,
  ...
  describe('screenColor32', () => {
    it('should return destination when source is transparent', () => {
      const src = 0x00FFFFFF as Color32
      const dst = 0xFF112233 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.screen(src, dst)
      expect(unpack(result)).toEqual({
        r: 51,
        g: 34,
        b: 17,
  ...
  describe('colorDodgeColor32', () => {
    it('should return destination when source is transparent', () => {
      const src = 0x00FFFFFF as Color32
      const dst = 0xFF112233 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.colorDodge(src, dst)
      expect(unpack(result)).toEqual({
        r: 51,
        g: 34,
        b: 17,
  ...
  describe('linearDodgeColor32', () => {
    it('should return destination when source is transparent', () => {
      const src = 0x00FFFFFF as Color32
      const dst = 0xFF112233 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.linearDodge(src, dst)
      expect(unpack(result)).toEqual({
        r: 51,
        g: 34,
        b: 17,
  ...
  describe('lighterColor32', () => {
    it('should return destination when source is transparent', () => {
      const src = 0x00FFFFFF as Color32
      const dst = 0xFF112233 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.lighterColor(src, dst)
      expect(unpack(result)).toEqual({
        r: 51,
        g: 34,
        b: 17,
  ...
  describe('overlayColor32', () => {
    it('should apply multiply logic when dst < 128', () => {
      ...
      const result = FAST_BLEND_MODE_BY_NAME.overlay(src, dst)
      expect(unpack(result)).toEqual({
        r: 16,
        g: 16,
        b: 16,
  ...
  describe('softLightColor32', () => {
    it('returns destination when source is fully transparent (sa === 0)', () => {
      const src = 0x00FFFFFF as Color32
      const dst = 0xFF112233 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.softLight(src, dst)
      expect(unpack(result)).toEqual({
        r: 51,
        g: 34,
        b: 17,
  ...
  describe('hardLightColor32', () => {
    it('returns destination when source is fully transparent (sa === 0)', () => {
      const src = 0x00FFFFFF as Color32
      const dst = 0xFF112233 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.hardLight(src, dst)
  ...
  describe('vividLightColor32', () => {
    it('explicitly triggers the sr === 0, sg === 0, and sb === 0 branches', () => {
      ...
      const src = 0xFF000000 as Color32
      const dst = 0xFF808080 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.vividLight(src, dst)
      const unpacked = unpack(result)
    ...
    describe('opaque source (sa === 255)', () => {
      ...
      it('covers the transition from Burn to Dodge logic', () => {
        ...
        const resLow = FAST_BLEND_MODE_BY_NAME.vividLight(srcLow, dst)
        const resHigh = FAST_BLEND_MODE_BY_NAME.vividLight(srcHigh, dst)
  ...
  describe('linearLightColor32', () => {
    it('returns destination when source is fully transparent (sa === 0)', () => {
      const src = 0x00FFFFFF as Color32
      const dst = 0xFF112233 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.linearLight(src, dst)
  ...
  describe('pinLightColor32', () => {
    it('covers the true cases for S >= 128 (dr > 2(sr-128))', () => {
      ...
      const src = 0xFFC0C0C0 as Color32
      const dst = 0xFFC8C8C8 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.pinLight(src, dst)
      const unpacked = unpack(result)
  ...
  describe('hardMixColor32', () => {
    it('thresholds components to 0 or 255 (sa === 255)', () => {
      const src = 0xFFC04040 as Color32
      const dst = 0xFF646464 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.hardMix(src, dst)
    ...
    it('covers the 255-snap branches (sr + dr >= 255) for all colors', () => {
      // Red: 128 + 127 = 255 (>= 255) -> 255
      // Green: 255 + 0 = 255 (>= 255) -> 255
      // Blue: 200 + 100 = 300 (>= 255) -> 255
      const src = 0xFFC8FF80 as Color32
      const dst = 0xFF64007F as Color32
      const result = FAST_BLEND_MODE_BY_NAME.hardMix(src, dst)
      const unpacked = unpack(result)
    ...
    it('handles the absolute edge cases (0 and 255) to hit guard branches', () => {
      ...
      const resMin = FAST_BLEND_MODE_BY_NAME.hardMix(srcMin, dstMin)

      const srcMax = 0xFFFFFFFF as Color32
      const dstMax = 0xFFFFFFFF as Color32
      const resMax = FAST_BLEND_MODE_BY_NAME.hardMix(srcMax, dstMax)
  ...
  describe('differenceColor32', () => {
    it('covers the positive result branches (dr - sr > 0) for all channels', () => {
      ...
      const dst = 0xFFC8C8C8 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.difference(src, dst)
      const unpacked = unpack(result)
  ...
  describe('exclusionColor32', () => {
    it('returns destination when source is fully transparent (sa === 0)', () => {
      const src = 0x00FFFFFF as Color32
      const dst = 0xFF112233 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.exclusion(src, dst)
  ...
  describe('subtractColor32', () => {
    it('covers the zero-clamp and positive branches for all channels', () => {
      ...
      const result1 = FAST_BLEND_MODE_BY_NAME.subtract(src1, dst1)
      ...
      const result2 = FAST_BLEND_MODE_BY_NAME.subtract(src2, dst2)
    ...
    it('should return black when source is white and opaque', () => {
      const src = 0xFFFFFFFF as Color32
      const dst = 0xFF445566 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.subtract(src, dst)
      expect(unpack(result)).toEqual({
        r: 0,
        g: 0,
        b: 0,
  ...
  describe('divideColor32', () => {
    it('should return white when source is zero (division by zero case)', () => {
      const src = 0xFF000000 as Color32
      const dst = 0xFF445566 as Color32
      const result = FAST_BLEND_MODE_BY_NAME.divide(src, dst)
      expect(unpack(result)).toEqual({
        r: 255,
        g: 255,
        b: 255,
